        ...
        {[1, 2, 3, 4, 5, 6, 8, 9, 10, 11].map((word, i) => (
          ...
          >
            ...
            <div className=" w-full flex h-fit">
                <input onChange={(e) => setSearchWord(e.target.value)}  placeholder="Enter Search Keyword" type="search" className=" flex-1 h-[60px]  rounded-[40px] outline-none  placeholder:text-dark placeholder:text-[20px] bg-transparent border-2 border-dark px-4" />
